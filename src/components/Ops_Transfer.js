 ...
 export  default function Transfer(){
    ...
    return (
        <>
            <div className="modal transition-bottom screenFull defaultModal mdlladd__rate fade" id="transfer-modal"
                 tabIndex="-1"
                    ...
                    <div className="modal-content">
                        <div className="modal-header padding-l-20 padding-r-20 justify-content-center">
                            <div className="itemProduct_sm">
                                <h1 className="size-18 weight-600 color-secondary m-0">Transfer</h1>
                            </div>
                        ...
                        <div className="modal-body">
                            <div className="padding-t-20">
                                <form action="#">
                                    ...
                                    <div className="form-group input-lined">
                                        <select className="form-control custom-select">
                                            <option value="Bills Account (**** 1942)">GTB
                                            </option>
                                            <option value="Default Account (**** 6540)">Default Account (****
                                                6540)
                                            </option>
                                    ...
                                    <div className="form-group input-lined relative">
                                        <input type="text" className="form-control" value="" min="0"
                                               placeholder="0000"
                                               required=""/>
            ...
            <div className="modal transition-bottom screenFull defaultModal confirm__transfer mdlladd__rate fade"
                 id="confirm-transfer-modal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header padding-l-20 padding-r-20 justify-content-center">
                            <div className="itemProduct_sm">
                                <h1 className="size-18 weight-600 color-secondary m-0">Confirm Transfer</h1>
                            </div>
                            <div className="absolute right-0 padding-r-20">
                                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                                    <i className="tio-clear"></i>
                        ...
                        <div className="modal-body">
                            <div className="padding-t-20 padding-b-30">
                                    ...
                                    <div className="item_trans">
                                        ...
                                        <div className="sideRight">
                                            <div className="icon sender">
                                                <svg id="Iconly_Light_Arrow_-_Up_Square"
                                    ...
                                    <div className="item_trans">
                                        ...
                                        <div className="sideRight">
                                            <div className="icon recipient">
                                                <svg id="Iconly_Light_Arrow_-_Down_Square"
                                ...
                                <p className="color-text size-13 text-center mb-0">You are sending <span
                                    className="color-secondary">150.00
                                    USD</span> to Adam.</p>
                            </div>
                        </div>
                        <div className="modal-footer">
