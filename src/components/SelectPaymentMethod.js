                            ...
                            <div className="padding-t-20 padding-b-30">
                                <section className="emSection__payment" style={{padding: 0}}>
                                    <div className="credite_saved itemSingle">
                                        ...
                                        {
                                            cards.map((card) => (
                                                <button type="button" className={`btn item item_credit ${card.id == selectedCardId && 'selected'}`} onClick={()=> setSelectedCardId(card.id)} key={card.id}>
                                    ...
                                    <div className="padding-20 px-0">
                                        <p className="size-14 color-text m-0">Choose a new method</p>
                                    </div>


           <Link to="/~/virtual-cards/new" className="btn itemPay" onClick={closeModals}>
                                    ...
                                    <nutton className="btn itemPay" onClick={handleFlutterPayment}>
