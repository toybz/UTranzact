export default function QrPay(){
    return (
        <div className="modal transition-bottom screenFull defaultModal mdlladd__rate fade" id="qr-modal"
             tabIndex="-1"
                ...
                <div className="modal-content">
                    <div className="modal-header padding-l-20 padding-r-20 justify-content-center">
                        <div className="itemProduct_sm">
                            <h1 className="size-18 weight-600 color-secondary m-0">QR Payment</h1>
                        </div>
                        ...
                        <div className="padding-t-20">
                            <form action="#">
                                ...
                                <div className="form-group input-lined relative">
                                    ...
                                    <span className="absolute right-0 top-0 mt-3 color-snow size-16">USD</span>
                                </div>
